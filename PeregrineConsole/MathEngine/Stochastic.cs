...
namespace PeregrineConsole.MathEngine
{
    public class Stochastic
    {
        ...
        private List<double> HighestHigh(string database, string stock, Transactions transactions) // set
        {
            ...
            // Low price Data
            List<double> Low = transactions.DatabasePriceQuery(database, stock, "Low"); // SQL query calls low price from database

            List<double> High = transactions.DatabasePriceQuery(database, stock, "High"); // High price
        ...
        private List<double> LowestLow(string database, string stock, Transactions transactions) // set
        {
            ...
            // Close price Data
            List<double> Close = transactions.DatabasePriceQuery(database, stock, "Close");

            // Low price Data
            List<double> Low = transactions.DatabasePriceQuery(database, stock, "Low");
