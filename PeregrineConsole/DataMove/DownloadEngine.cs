...
namespace ResearchLibrary.DataMove
{
    ...
    public class DownloadEngine
    {
        ...
        public void ToDatabase(DateTime date,Formatting formatting, PeregrineOperation peregrine,Transactions transactions,WebClient web, WebURIs uRIs, string stock, string Database)
        {
            ...
            transactions.SaveToTableStockPrices(Database, DailyStockData);

            transactions.SaveToCleanData(Database, stock); // write clean list to Table
        ...
        public int DatabaseCIKQuery(string database, string stock)
        {
        ...
        {
            List<DateTime> latestDate = transactions.DatabaseDateQuery(peregrine.Database, stock);
