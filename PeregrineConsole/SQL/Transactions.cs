...
namespace ResearchLibrary.SQL
{
    ...
    {
        public void SaveToTableStockPrices(string database, List<Stock> stock)
        {
            FileLocations locations = new FileLocations();

            var connectionString = locations.DatabaseConnectionString(database); // returns Database connectionstring for SQLConnection
        ...
        public void TruncateStockTable(string database, string tablename)
        {
            FileLocations locations = new FileLocations();
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                command.CommandText = $"Use {database}"; // ensures the query is using the correct database
                command.ExecuteNonQuery();
        ...
        public void SaveToCleanData(string database, string stock)
        {
            FileLocations locations = new FileLocations();
        ...
        /// <returns></returns>
        public List<double> DatabasePriceQuery(string database, string stock, string priceSet) /// TODO: make this method able to retrieve any price.
        {
            FileLocations locations = new FileLocations();
        ...
        /// <returns></returns>
        public List<string> DatabaseSymbolListQuery(string database, string table)
        {
            FileLocations locations = new FileLocations();
        ...
        /// <param name="stock"></param>
        /// <returns></returns>
        public List<double> NiftyFiftyQuery(string database, string stock) /// TODO: make this method able to retrieve any price.
        {
            FileLocations locations = new FileLocations();
        ...
        public double CloseQuery(string database, string stock) /// TODO: make this method able to retrieve any price.
        {
            FileLocations locations = new FileLocations();
        ...
        public List<DateTime> DatabaseDateQuery(string database, string stock)
        {
            FileLocations locations = new FileLocations();
        ...
        public List<DateTime> DatabaseDateQuery(string database)
        {
            FileLocations locations = new FileLocations();
        ...
        public void SaveToTableWebResult(string database, List<PeregrineResults> results)
        {
            FileLocations locations = new FileLocations();
        ...
        /// <param name="database"></param>
        /// <returns></returns>
        public List<PeregrineResults> DailyResultsQuery(string database) /// TODO: reapply date as string
        {
            FileLocations locations = new FileLocations();
